...
var B = () => {
  ...
  function s2(t3) {
    const n3 = e2?.getConfig?.().markdown;
    return (t3 = t3 || {}).separator = t3.separator || n3?.separator || "\r?\n---\r?\n", t3.verticalSeparator = t3.verticalSeparator || n3?.verticalSeparator || null, t3.notesSeparator = t3.notesSeparator || n3?.notesSeparator || "^s*notes?:", t3.attributes = t3.attributes || "", t3;
  }
  function r2(e3, t3) {
    t3 = s2(t3);
